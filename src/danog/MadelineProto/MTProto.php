...
class MTProto
{
    ...
    */
    ...
    {
        return ['settings', 'config', 'authorization', 'authorized', 'rsa_keys', 'last_recv', 'dh_config', 'last_stored', 'dialog_params', 'datacenter', 'v', 'constructors', 'methods', 'twoe1984', 'twoe2047', 'twoe2048', 'zero', 'one', 'two', 'three', 'four', 'storage'];
    }
...
//                'app_version'     => self::V,
    ...
    public function connect_to_one_dc()
    {
